<?php
	...
	{		
		...
		$data = new data($db);
		$statement = $data->showPembelian($from_record_num, $records_per_page);
...
//					echo "<td>" . $row['item_kode'] . "</td>";
				...
				echo "<a href='pembeliandetail.php?id={$purchase_id}' title='Lihat' class='btn btn-success col-sm-7'>Lihat";
