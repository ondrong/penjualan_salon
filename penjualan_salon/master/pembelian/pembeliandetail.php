<?php
	...
	{		
			...
			$page_title = "Data Pembelian Detail";
		...
		$data = new data($db);
		$purchase_id=$kode;
		$data->purchase_id = $kode;
		$statement = $data->ShowPembeliandetail($purchase_id);
	...
	?>
		...
		<div>
			<ol class="breadcrumb">
				<li><a href="/">Home</a></li>
				<li><a href="/master/pembelian/pembelian.php">Data Pembelian</a></li>
