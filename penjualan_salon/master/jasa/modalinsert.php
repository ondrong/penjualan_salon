	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Tambah Data Jasa Salon</h4>
			</div>
		...
		echo "	<input type='text' class='form-control' name='item_kode' placeholder='Kode Jasa' required>";
		echo "  </div>";
		echo "</div>";
		...
		echo "  <div class='col-sm-7'>";
		echo "	<input type='text' class='form-control' name='item_name' placeholder='Nama Jasa' required>";
		echo "  </div>";
		echo "</div>";
		...
		echo "  <div class='col-sm-7'>";
		echo "	<textarea type='text' class='form-control' name='item_note' placeholder='Keterangan Jasa' required></textarea>";
		echo "  </div>";
		echo "</div>";
		...
		echo "  <div class='col-sm-7'>";
		echo "	<input type='number' class='form-control' name='harga' placeholder='Rp .' required>";
		echo "  </div>";
		echo "</div>";
				?>
				<div class="row">
